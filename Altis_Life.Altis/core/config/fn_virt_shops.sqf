...
switch (_shop) do
{
	case "market": {["Altis Market",["grapes","water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","storagesmall","storagebig"]]};
	...
	case "wongs": {["Taste of ChinaTown",["turtlesoup","turtle","moonshine"]]};
